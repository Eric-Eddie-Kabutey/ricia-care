            ...
            <div className='container mx-auto flex items-center justify-between h-16 lg:max-w-5xl xl:max-w-6xl'>
				...
				<div className='mr-4 hidden md:flex'>
					<Link href='/' className='mr-6 flex items-center space-x-2'>                        
                        <Image src="/assets/logo/site-logo.png" alt='Site logo' width={100} height={60} />
					</Link>
                </div>
				...
				<div className='flex flex-1 items-center justify-between space-x-2 lg:hidden px-6 bg-white dark:bg-white'>
						...
						<SheetContent side='right' className='pr-0 flex flex-col p-6'>
							...
							<div className='mt-auto pt-6'>
								<div className='flex flex-col space-y-2'>
									...
									<Link
										href='/auth/register'
										className='w-full text-center py-2 bg-[#34765A] text-white rounded-md'>
										Register
									</Link>
								</div>
							</div>
					...
					<div className='hidden lg:flex items-center justify-end space-x-4 bg-white dark:bg-white'>
						<nav className='flex items-center space-x-2'>
							<Link href='/auth/sign-in' className='py-2 px-4 border rounded-md text-sm text-black'>
								Sign In
							</Link>
							<Link
								href='/auth/register'
								className='py-2 px-4 bg-[#34765A] text-white rounded-md text-sm'>
								Register
							</Link>
						</nav>
					</div>
